...
> **This document covers the Garmin MCP server only.** It is the provider
> boundary Paceboard reads Garmin data through, and it also works standalone
> with Claude Desktop or any MCP client. For the Paceboard dashboard — the
> local-first analytics application built on top of it — see
> [README.md](README.md).
